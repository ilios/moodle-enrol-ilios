...
$string['cohort'] = 'Cohort for each program year (Number of learner groups)';
...
$string['learnergroup'] = 'Learner group (Number of subgroups) (Number of people in this group)';
