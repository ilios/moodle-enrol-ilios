...
$string['custominstancename_help'] = 'The name of this enrolment instance. If left empty, then Moodle will auto-generate a name based on user selections made below.';
